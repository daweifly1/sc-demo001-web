...
export namespace PurchaseOutServiceNs {
  ...
  export class PurchaseOutServiceClass {
    ...
    /**结单 */
    public statementFinish(id: string, detailVOIdList): Observable<UfastHttpResT<any>> {
      // return this.http.Post<UfastHttpResT<any>>('/refund/endBill', {refundCode: refundCode,
      // materialNo: materialNo || null}, this.defaultConfig);
      return this.http.Post<UfastHttpResT<any>>('/refund/endBill', {
        id: id,
        detailVOIdList
      }, this.defaultConfig);
    }
