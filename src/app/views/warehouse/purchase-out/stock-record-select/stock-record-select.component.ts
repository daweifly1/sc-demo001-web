...
export class StockRecordSelectComponent implements OnInit {
  ...
  ngOnInit() {
    this.tableConfig = {
      ...
      loading: false,
      headers: [
        { title: '合同号', field: 'contractNo', width: 220, fixed: true },
        { title: '接收号', field: 'erpNo', width: 100 },
        { title: '物料号', field: 'materialCode', width: 120 },
        { title: '入库数量', field: 'amountIn', width: 100 },
        { title: '入库单号', field: 'billNo', width: 180 },
        { title: 'ERP入库行id', field: 'erpDeliveryTrxId ', width: 120 },
