...
export class BeginningWarehouseComponent implements OnInit {
  ...
  constructor(private beginningWarehouseService: BeginningWarehouseService, private utilService: UfastUtilService,
    private messageService: ShowMessageService, private formBuilder: FormBuilder, private printService: PrintTplSelectorService,
  ...
  public leadingIn() {
    ...
    const req = new HttpRequest('POST', environment.baseUrl.ss + '/initialInventory/import', formData, {
    });
