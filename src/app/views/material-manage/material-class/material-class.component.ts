...
export class MaterialClassComponent implements OnInit {
  ...
  public toAddPage(pid = '0', materialType?: string): void {
  ...
  public addChildClass(id: string, materialType: string, materialClassName: string): void {
    ...
    this.toAddPage(id, materialType);
  }
  ...
  ngOnInit() {
    this.tableConfig = {
      ...
      headers: [{title: '操作', tdTemplate: this.operationTpl, width: 180, fixed: true},
        ...
        {title: '物料类别', field: 'materialType', width: 140, pipe: 'materialType'},
